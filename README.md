...
The "Quotes page" submenu item opens a page with all quotes in a sortable list.
...
Fix: settings form now works also in offline mode, and when Yahoo is unavailable.
