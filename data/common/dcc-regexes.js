...
if (!this.PriceRegexes) {
    const PriceRegexes = (function() {
        ...
        const makePriceRegexes = function(aRegex1, aRegex2) {
            ...
            const end = "(?!\\s)";
            const makeRegex1 = function(reg, mult) {
...
//                console.log(completeRegString);
            ...
            const makeRegex2 = function(reg, mult) {
...
//                console.log(completeRegString);
            ...
            try {
                ...
                aRegex2.ALL = makeRegex2("(ALL|[lL]ekë?|L|qindarkë|qindarka)");
                aRegex1.AMD = makeRegex1("(AMD|\\u058F|Դրամ|drams?|драм)");
                aRegex2.AMD = makeRegex2("(AMD|\\u058F|Դրամ|drams?|драм|luma)");
                aRegex1.ANG = makeRegex1("(ANG|NAƒ|ƒ|NAf\\.?)");
                aRegex2.ANG = makeRegex2("(ANG|NAƒ|ƒ|NAf\\.?|\\sgulden|[cC]ents?)");
                ...
                aRegex2.AZN = makeRegex2("(AZN|₼|manat|man\\.?|qapik)");
                aRegex1.BAM = makeRegex1("(BAM|KM)");
                aRegex2.BAM = makeRegex2("(BAM|KM|pf)");
                aRegex1.BBD = makeRegex1("(BBD|Bds\\$?|\\$)");
                aRegex2.BBD = makeRegex2("(BBD|\\$|dollars?|[cC]ents?)");
                aRegex1.BDT = makeRegex1("(BDT|৳|Tk\\.?|Taka)");
                aRegex2.BDT = makeRegex2("(BDT|টাকা|Tk|taka|poisha)");
                aRegex1.BGN = makeRegex1("(BGN)");
                aRegex2.BGN = makeRegex2("(BGN|лв\\.?|лева?|lv\\.?|leva?|stotinka|stotinki)");
                aRegex1.BHD = makeRegex1("(BHD|دينار|BD\\.?|\\.د\\.ب)");
                aRegex2.BHD = makeRegex2("(BHD|\\.د\\.ب|dinars?|دينار|fils)");
                aRegex1.BIF = makeRegex1("(BIF)");
                aRegex2.BIF = makeRegex2("(BIF|Fbu?|francs|Fr)");
                aRegex1.BMD = makeRegex1("(BMD\\$|BMD|BD\\$?|Bd\\$?|\\$)");
                aRegex2.BMD = makeRegex2("(BMD|\\$|dollars?|[cC]ents?)");
                aRegex1.BND = makeRegex1("(BND\\$|BND|B\\$|\\$)");
                aRegex2.BND = makeRegex2("(BND|\\$|dollars?|[cC]ents?)");
                aRegex1.BOB = makeRegex1("(BOB|Bs\\.?)");
                aRegex2.BOB = makeRegex2("(BOB|Bs\\.?|Bolivianos?|centavos?)");
                aRegex1.BOV = makeRegex1("(BOV)");
                aRegex2.BOV = makeRegex2("(BOV|MVDOL|centavos?)");
                aRegex1.BRL = makeRegex1("(BRL|R\\$)");
                aRegex2.BRL = makeRegex2("(BRL|R\\$|real|reais|centavos?)");
                aRegex1.BSD = makeRegex1("(BSD|BSD\\$|B\\$|\\$)");
                aRegex2.BSD = makeRegex2("(BSD|\\$|dollars?|[cC]ents?)");
                aRegex1.BTN = makeRegex1("(BTN|Nu\\.?)");
                aRegex2.BTN = makeRegex2("(BTN|[nN]gultrum|དངུལ་ཀྲམ|chhertum)");
                aRegex1.BWP = makeRegex1("(BWP|\\sP)");
                aRegex2.BWP = makeRegex2("(BWP|pula|thebe)");
                aRegex1.BYN = makeRegex1("(BYN|Br\\.?|бр\\.?)");
                aRegex2.BYN = makeRegex2("(BYN|Br\\.?|бр\\.?|рубель|рублёў|рублей|rubles?|kopek|капейка|капейкі)");
                aRegex1.BZD = makeRegex1("(BZD|BZ\\s?\\$|\\$)");
                aRegex2.BZD = makeRegex2("(BZD|\\$|dollars?|[cC]ents?)");
                aRegex1.CAD = makeRegex1("(CAD|CAD\\$|C\\$|\\$)");
                aRegex2.CAD = makeRegex2("(CAD|\\$|dollars?|[cC]ents?)");
                aRegex1.CDF = makeRegex1("(CDF|F[Cc])");
                aRegex2.CDF = makeRegex2("(CDF|F[Cc]|francs|centimes?)");
                aRegex1.CHE = makeRegex1("(CHE)");
                aRegex2.CHE = makeRegex2("(CHE)");
                aRegex1.CHF = makeRegex1("(CHF|Fr\\.)");
                aRegex2.CHF = makeRegex2("(CHF|Fr\\.|Franken|Rappen|centimes?|centesimo|centesimi|rap)");
                ...
                aRegex2.CNY = makeRegex2("(CNY|¥|[yY]u[áa]n|[rR]enminbi|RMB|fen|fēn)");
                aRegex1.COP = makeRegex1("(COP|COP\\s?\\$|COL\\$|Col\\$|CO\\$|\\$)");
                aRegex2.COP = makeRegex2("(COP|pesos?|centavos?)");
                aRegex1.COU = makeRegex1("(COU)");
                aRegex2.COU = makeRegex2("(COU|UVR|Unidades de Valor Real|centavos?)");
                aRegex1.CRC = makeRegex1("(CRC|₡)");
                aRegex2.CRC = makeRegex2("(CRC|[cC]ol[oó]n(es)|céntimos?|centimo?)");
                aRegex1.CUC = makeRegex1("(CUC|CUC\\s?\\$|\\$)");
                aRegex2.CUC = makeRegex2("(CUC|[pP]esos [cC]onvertibles|centavos?)");
                aRegex1.CUP = makeRegex1("(CUP|CUP\\s?\\$|MN\\$|\\$)");
                aRegex2.CUP = makeRegex2("(CUP|[pP]esos?|centavos?)");
                aRegex1.CVE = makeRegex1("(CVE)");
                aRegex2.CVE = makeRegex2("(CVE|\\$|ESC(UDOS)?|Esc(udos)?|esc(udos)?)");
                aRegex1.CZK = makeRegex1("(CZK)");
                aRegex2.CZK = makeRegex2("(CZK|Kč|koruna?y?|haléř|haléře|haléřů)");
                ...
                aRegex2.DZD = makeRegex2("(DZD|دج|DA|dinars?|centimes?)");
                aRegex1.EGP = makeRegex1("(EGP|L\\.?E\\.?\\s?|E£|ج\\.م)");
                aRegex2.EGP = makeRegex2("(EGP|L\\.?E|EGL|E£|ج\\.م|pounds?|piastres?)");
                aRegex1.ERN = makeRegex1("(ERN|Nkf|Nfk|NFA|ናቕፋ)");
                aRegex2.ERN = makeRegex2("(ERN|Nkf|Nfk|ናቕፋ|[nN]akfa|[cC]ents?)");
                aRegex1.ETB = makeRegex1("(ETB|Br\\.?|ብር|Birr)");
                aRegex2.ETB = makeRegex2("(ETB|Br|ብር|[bB]irr|santim)");
                aRegex1.EUR = makeRegex1("(EUR|€|euro)");
                aRegex2.EUR = makeRegex2("(EUR|€|euros?t?a?|евро|evro|euri|eura|ευρώ|evrō|euró|evrur|eiro|eurai|eurų|euras|ewros?|eòrathan|eurá|eúr|evro|evra|evri|evrov|欧元|[cC]ents?)");
                ...
                aRegex2.GHS = makeRegex2("(GHS|GH₵|cedi|pesewa)");
                aRegex1.GIP = makeRegex1("(GIP|£)");
                aRegex2.GIP = makeRegex2("(GIP|pounds?|penny|pence)");
                aRegex1.GMD = makeRegex1("(GMD|D)");
                aRegex2.GMD = makeRegex2("(GMD|Dalasis?|butut)");
                aRegex1.GNF = makeRegex1("(GNF)");
                aRegex2.GNF = makeRegex2("(GNF|FG|fg|francs?)");
                aRegex1.GTQ = makeRegex1("(GTQ|Q\\.?)");
                aRegex2.GTQ = makeRegex2("(GTQ|Q|quetzal(es)?|q|centavos?)");
                aRegex1.GYD = makeRegex1("(GYD|GYD\\$|G\\$|\\$)");
                aRegex2.GYD = makeRegex2("(GYD|\\$|dollars?|[cC]ents?)");
                aRegex1.HKD = makeRegex1("(HKD|HK\\$|\\$)");
                aRegex2.HKD = makeRegex2("(HKD|\\$|dollars?|[cC]ents?)");
                aRegex1.HNL = makeRegex1("(HNL|L\\.?)");
                aRegex2.HNL = makeRegex2("(HNL|lempiras?|centavos?)");
                aRegex1.HRK = makeRegex1("(HRK)");
                aRegex2.HRK = makeRegex2("(HRK|kn|kuna|lipa)");
                aRegex1.HTG = makeRegex1("(HTG)");
                aRegex2.HTG = makeRegex2("(HTG|[gG]ourdes?|G|centimes?)");
                aRegex1.HUF = makeRegex1("(HUF)");
                aRegex2.HUF = makeRegex2("(HUF|Ft|forint|fillér)");
                aRegex1.IDR = makeRegex1("(IDR|Rp\\.?)");
                aRegex2.IDR = makeRegex2("(IDR|[rR]upiah|sen)");
                aRegex1.ILS = makeRegex1("(ILS|NIS|₪|שֶׁקֶל)");
                aRegex2.ILS = makeRegex2("(ILS|NIS|₪|שֶׁקֶל|shekel|agora)");
                aRegex1.INR = makeRegex1("(INR|₹|₨|Rs\\.?|रु\\.?|ரூ\\.?)");
                aRegex2.INR = makeRegex2("(INR|Rs\\.?|rupees|paisa)");
                aRegex1.IQD = makeRegex1("(IQD|دينار|د\\.ع)");
                aRegex2.IQD = makeRegex2("(IQD|دينار|د\\.ع|dinars?|fils)");
                ...
                aRegex2.JOD = makeRegex2("(JOD|JD|dinars?|دينار|fils)");
                aRegex1.JPY = makeRegex1("(JPY|¥|￥|yen|円|圓)");
                aRegex2.JPY = makeRegex2("(JPY|¥|￥|yen|円|圓)");
                aRegex1.KES = makeRegex1("(KES|Kshs?\\.?|KSh|KSH)");
                aRegex2.KES = makeRegex2("(KES|ksh|Shillings?|[cC]ents?)");
                aRegex1.KGS = makeRegex1("(KGS)");
                aRegex2.KGS = makeRegex2("(KGS|soms?|сом|tyiyn)");
                aRegex1.KHR = makeRegex1("(KHR|៛|រៀល)");
                aRegex2.KHR = makeRegex2("(KHR|៛|រៀល|[rR]iels?|sen)");
                aRegex1.KMF = makeRegex1("(KMF)");
                aRegex2.KMF = makeRegex2("(KMF|[fF][cC]|francs?)");
                aRegex1.KPW = makeRegex1("(KPW|₩|￦|원)");
                aRegex2.KPW = makeRegex2("(KPW|₩|￦|원|wons?|chon)");
                aRegex1.KRW = makeRegex1("(KRW|₩|￦|원)");
                aRegex2.KRW = makeRegex2("(KRW|₩|￦|원|wons?)");
                aRegex1.KWD = makeRegex1("(KWD|دينار|K\\.?D\\.?\\.?|\\.د\\.ب)");
                aRegex2.KWD = makeRegex2("(KWD|K\\.?D\\.?|\\.د\\.ب|dinars?|دينار|fils)");
                aRegex1.KYD = makeRegex1("(KYD|KYD\\$?|CI\\$|\\$)");
                aRegex2.KYD = makeRegex2("(KYD|[cC]ents?)");
                aRegex1.KZT = makeRegex1("(KZT|₸)");
                aRegex2.KZT = makeRegex2("(KZT|₸|tenge|теңге|tïın)");
                aRegex1.LAK = makeRegex1("(LAK|ກີ|₭N?|KIP)");
                aRegex2.LAK = makeRegex2("(LAK|ກີ|₭N?|[kK]ip|KIP|att|ອັ)");
                aRegex1.LBP = makeRegex1("(LBP|L\\.L\\.?|ل\\.ل\\.|ليرات)");
                aRegex2.LBP = makeRegex2("(LBP|Lebanese [pP]ounds?|L\\.L\\.?|ل\\.ل\\.|ليرات|piastres?)");
                aRegex1.LKR = makeRegex1("(LKR|රු|₨\\.?|SLRs\\.?|Rs\\.?|ரூபாய்\\.?|රුපියල්\\.?)");
                aRegex2.LKR = makeRegex2("(LKR|Rs\\.?|rupees|ரூபாய்|[cC]ents?)");
                aRegex1.LRD = makeRegex1("(LRD|LD\\$?|L\\$|\\$)");
                aRegex2.LRD = makeRegex2("(LRD|\\$|dollars?|[cC]ents?)");
                aRegex1.LSL = makeRegex1("(LSL|Maloti|M|Loti)");
                aRegex2.LSL = makeRegex2("(LSL|Maloti|LOTI|sente|lisente)");
                aRegex1.LYD = makeRegex1("(LYD|L\\.?D\\.?|ل\\.د|دينار)");
                aRegex2.LYD = makeRegex2("(LYD|L\\.?D\\.?|ل\\.د|دينار|dinars?|dirham)");
                aRegex1.MAD = makeRegex1("(MAD|د\\.م\\.|دراهم)");
                aRegex2.MAD = makeRegex2("(MAD|د\\.م\\.|دراهم|dhs|Dh\\.?|dirhams?|santim)");
                ...
                aRegex2.MMK = makeRegex2("(MMK|[kK][sS]|[kK]yat|ကျပ်|pya)");
                ...
                aRegex2.MVR = makeRegex2("(MVR|mrf|Rufiyaa|laari)");
                aRegex1.MWK = makeRegex1("(MWK|MwK|Mwk|M?K)");
                aRegex2.MWK = makeRegex2("(MWK|MK|[kK]wacha|tambala)");
                aRegex1.MXN = makeRegex1("(MXN|MEX\\$|Mex\\$|\\$)");
                aRegex2.MXN = makeRegex2("(MXN|MEX\\$|Mex\\$|[pP]esos?|centavos?)");
                ...
                aRegex2.MYR = makeRegex2("(MYR|[rR]inggit|sen)");
                aRegex1.MZN = makeRegex1("(MZN)");
                aRegex2.MZN = makeRegex2("(MZN|MTn|[mM]etical|[mM]eticais|centavos?)");
                aRegex1.NAD = makeRegex1("(NAD|N?\\$)");
                aRegex2.NAD = makeRegex2("(NAD|dollars?|[cC]ents?)");
                aRegex1.NGN = makeRegex1("(NGN|₦|N)");
                aRegex2.NGN = makeRegex2("(NGN|[nN]aira|kobo)");
                ...
                aRegex2.NZD = makeRegex2("(NZD|[dD]ollars?|[cC]ents?)");
                aRegex1.OMR = makeRegex1("(OMR|ر\\.ع\\.|ر\\.ع|ريال‎|[rR]ials?|R\\.?O\\.?)");
                aRegex2.OMR = makeRegex2("(OMR|ريال عماني|ر\\.ع\\.|ر\\.ع|ريال‎|Omani [rR]ials?|[rR]ials?|baisa)");
                aRegex1.PAB = makeRegex1("(PAB|B\\/\\.?)");
                aRegex2.PAB = makeRegex2("(PAB|[bB]alboa|centésimos?|centesimos?)");
                aRegex1.PEN = makeRegex1("(PEN|S\\/\\.?)");
                aRegex2.PEN = makeRegex2("(PEN|SOL|Sol(es)?|sol(es)?|céntimos?|centimos?)");
                ...
                aRegex2.PLN = makeRegex2("(PLN|zł|złoty|zlotys?|grosz)");
                aRegex1.PYG = makeRegex1("(PYG|₲|Gs?\\.?)");
                aRegex2.PYG = makeRegex2("(PYG|[gG]s\\.?|guaraní(es)?)");
                aRegex1.QAR = makeRegex1("(QAR|QR\\.?|ريال|ر\\.ق)");
                aRegex2.QAR = makeRegex2("(QAR|[rR]iyals?|ريال|ر\\.ق|dirham)");
                aRegex1.RON = makeRegex1("(RON)");
                aRegex2.RON = makeRegex2("(RON|[lL]eu|[lL]ei|bani?)");
                aRegex1.RSD = makeRegex1("(RSD)");
                aRegex2.RSD = makeRegex2("(RSD|РСД|dinars?|din\\.?|динара?|дин\\.?|para)");
                aRegex1.RUB = makeRegex1("(RUB|₽)");
                aRegex2.RUB = makeRegex2("(RUB|₽|рублей|рубль|руб\\.?|[рP]\\.|[rR]o?ubles?|rub\\.?|коп.?|kopek|копеек)");
                ...
                aRegex2.SAR = makeRegex2("(SAR|SR|﷼|ريال|ر\\.س|Saudi [rR]iyals?|[rR]iyals?|halalah|هللة)");
                aRegex1.SBD = makeRegex1("(SBD\\.?\\$?|SI\\$|\\$)");
                aRegex2.SBD = makeRegex2("(SBD|\\$|dollars?|[cC]ents?)");
                aRegex1.SCR = makeRegex1("(SCR|SR|Sr\\.?)");
                aRegex2.SCR = makeRegex2("(SCR|[rR]upees?|[rR]oupies?|[cC]ents?)");
                ...
                aRegex2.SHP = makeRegex2("(SHP|pounds?|penny|pence)");
                aRegex1.SLL = makeRegex1("(SLL|L[eE]\\.?)");
                aRegex2.SLL = makeRegex2("(SLL|[lL]eone|[cC]ents?)");
                aRegex1.SOS = makeRegex1("(SOS)");
                aRegex2.SOS = makeRegex2("(SOS|Sh\\.?\\s?So\\.?|[sS]hillings?|senti)");
                ...
                aRegex2.SYP = makeRegex2("(SYP|S\\.?P\\.?|(de )?L\\.?S\\.?|(Syrian )?[pP]ounds?|[lL]ivres? [sS]yriennes?|[lL]ivres?|ليرة|piastre)");
                aRegex1.SZL = makeRegex1("(SZL|[eE]malangeni|E)");
                aRegex2.SZL = makeRegex2("(SZL|Lilangeni|[cC]ents?)");
                aRegex1.THB = makeRegex1("(THB|฿)");
                aRegex2.THB = makeRegex2("(THB|(Thai )?[bB]aht|บาท|satang)");
                aRegex1.TJS = makeRegex1("(TJS|سامانی)");
                aRegex2.TJS = makeRegex2("(TJS|[sS]omoni|cомонӣ|diram)");
                aRegex1.TMT = makeRegex1("(TMT)");
                aRegex2.TMT = makeRegex2("(TMT|[mM]anat|манат|tenge|teňňe)");
                aRegex1.TND = makeRegex1("(TND)");
                aRegex2.TND = makeRegex2("(TND|DT|[dD][tT]|[dD]inars?|د\\.ت|دينار|milli(me)?)");
                aRegex1.TOP = makeRegex1("(TOP|TOP\\$|T?\\$)");
                aRegex2.TOP = makeRegex2("(TOP|[pP]a'anga|seniti)");
                aRegex1.TRY = makeRegex1("(TRY|₺|TL)");
                aRegex2.TRY = makeRegex2("(TRY|[lL]ira|TL|kuruş)");
                aRegex1.TTD = makeRegex1("(TTD|TTD\\$?|TT\\$|\\$)");
                aRegex2.TTD = makeRegex2("(TTD|dollars?|[cC]ents?)");
                aRegex1.TWD = makeRegex1("(TWD|NT\\$|\\$)");
                aRegex2.TWD = makeRegex2("(TWD|NTD|dollars?|[cC]ents?|分|fēn)");
                aRegex1.TZS = makeRegex1("(TZS|TZs|Tsh\\.?)");
                aRegex2.TZS = makeRegex2("(TZS|TSH|Tsh|(Tanzanian )?[sS]hillings?|senti|[cC]ents?)");
                ...
                aRegex1.USD = makeRegex1("(USD|USD\\s?\\$?|US\\s?\\$|Us\\s?\\$|\\$|\\$USD|U\\$S)", "([mM]illions?|[bB]illions?)?");
                aRegex2.USD = makeRegex2("(USD|US\\s?\\$|Us\\s?\\$|\\$|[dD]ollars?|¢|￠|[cC]ents?)", "([mM]millions?|[bB]illions?)?");
                ...
                aRegex2.UYU = makeRegex2("(UYU|\\$U|[pP]esos?|centésimos?|centesimos?)");
                aRegex1.UZS = makeRegex1("(UZS)");
                aRegex2.UZS = makeRegex2("(UZS|uzs|som|сўм|сум|tiyin)");
                aRegex1.VEF = makeRegex1("(VEF|[bB]s\\.?[fF]?\\.?)");
                aRegex2.VEF = makeRegex2("(VEF|[bB]s\\.?[fF]?|[bB]olívar(es)?|céntimos?|centimos?)");
                aRegex1.VND = makeRegex1("(VND|₫)");
                aRegex2.VND = makeRegex2("(VND|vnd|vnđ|₫|[dD]ong|đồng|đ|ĐỒNG|VNĐ|Đ)", "([nN]gàn|[tT]riệu|[tT]ỷ)?");
                aRegex1.VUV = makeRegex1("(VUV|VT|Vt)");
                aRegex2.VUV = makeRegex2("(VUV|VT|vt|[vV]atu)");
                aRegex1.WST = makeRegex1("(WST|WST\\$?|WS\\$|\\$|SAT\\$?|ST\\$)");
                aRegex2.WST = makeRegex2("(WST|WST\\$?|[tT]ālā|[tT]ala|sene)");
                ...
                aRegex2.XCD = makeRegex2("(XCD|ECD|[dD]ollars?|[cC]ents?)");
                ...
                aRegex2.YER = makeRegex2("(YER|Y\\.?R\\.?|[rR]iy?als?|﷼|ريال|fils)");
                aRegex1.ZAR = makeRegex1("(ZAR|R)");
                aRegex2.ZAR = makeRegex2("(ZAR|[rR]ands?|[cC]ents?)");
                aRegex1.ZMW = makeRegex1("(ZMW|Zmk|K)");
                aRegex2.ZMW = makeRegex2("(ZMW|[kK]wacha|ngwee)");
                aRegex1.ZWL = makeRegex1("(ZWL|Z\\$)");
                aRegex2.ZWL = makeRegex2("(ZWL|[cC]ents?)");
