...
const DirectCurrencyContent = (function() {
    ...
    const makePriceRegexes = function(aRegex1, aRegex2) {
        ...
        aRegex1.BMD = /(BMD\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BND = /(BND\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BOB = /(BOB\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BOV = /(BOV\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BRL = /(BRL\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BSD = /(BSD\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BTN = /(BTN\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BWP = /(BWP\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        aRegex1.BYR = /(BYR\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/ig;
        ...
        aRegex2.BND = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BND)/ig;
        aRegex2.BOB = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BOB)/ig;
        aRegex2.BOV = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BOV)/ig;
        aRegex2.BRL = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BRL)/ig;
        aRegex2.BSD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BSD)/ig;
        aRegex2.BTN = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BTN)/ig;
        aRegex2.BWP = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BWP)/ig;
        aRegex2.BYR = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BYR)/ig;
        aRegex2.BZD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?BZD)/ig;
