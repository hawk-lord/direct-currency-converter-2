...
const DirectCurrencyContent = (function() {
    ...
    const makePriceRegexes = function(aRegex1, aRegex2) {
        ...
        aRegex1.BZD = /(BZD\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex1.BZD = /(BZD\s?|BZ\s?\$\s?|\$\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.BZD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?\$|\s?dollars?|\s?BZD)/g;
        aRegex1.CAD = /(CAD\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.CAD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?CAD)/g;
        aRegex1.CDF = /(CDF\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.CDF = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?CDF)/g;
        ...
        aRegex1.CLF = /(CLF\s?)((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.CLF = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)(\s?CLF)/g;
