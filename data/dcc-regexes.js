const PriceRegexes = (function() {
    const makePriceRegexes = function(aRegex1, aRegex2) {
        ...
        aRegex2.XOF = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(XOF|xof|FCFA|Fcfa|CFA [fF]rancs?|Frs CFA|CFA|cfa|[fF]rancos?|[fF]rancs?|[fF]rancos?|[fF])/g;
        ...
        aRegex2.XPF = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(XPF|CFP|cfp|[fF]\s?(cfp)|(CFP)|[fF]rcs CFP|[fF]rcs|[fF]rancs?|[fF])/g;
        ...
        aRegex2.YER = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(YER|Y\.?R\.?|[rR]iy?als?|﷼|ريال)/g;
        aRegex1.ZAR = /(^|\s)(ZAR|R)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.ZAR = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(ZAR|[rR]ands?)/g;
        aRegex1.ZMW = /(^|\s)(ZMW|Zmk|K)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.ZMW = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(ZMW|[kK]wacha)/g;
