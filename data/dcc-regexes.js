const PriceRegexes = (function() {
    const makePriceRegexes = function(aRegex1, aRegex2) {
        ...
        aRegex1.CNY = /(CNY|¥|[yY]u[áa]n|[rR]enminbi|RMB)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.CNY = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(CNY|¥|[yY]u[áa]n|[rR]enminbi|RMB)/g;
        aRegex1.COP = /(COP\s?\$|COP|COL\$|Col\$|CO\$|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        ...
        aRegex1.CUC = /(CUC\s?\$|CUC|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.CUC = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(CUC|[pP]esos [cC]onvertibles)/g;
        aRegex1.CUP = /(CUP\s?\$|CUP|MN\$|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        ...
        aRegex1.DOP = /(DOP\s?\$|DOP|RD\$|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.DOP = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(DOP|pesos?)/g;
        aRegex1.DZD = /(DZD|دج|DA)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.DZD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(DZD|دج|DA|dinars?)/g;
        aRegex1.EGP = /(EGP|L\.?E\.?\s?|E£|ج.م)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.EGP = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(EGP|L\.?E|EGL|E£|ج.م|pounds?)/g;
        aRegex1.ERN = /(ERN|Nkf|Nfk|NFA|ናቕፋ)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.ERN = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(ERN|Nkf|Nfk|ናቕፋ|[nN]akfa)/g;
        aRegex1.ETB = /(ETB|Br\.?|ብር|Birr)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        ...
        aRegex1.FJD = /(FJD|FJ\$?|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.FJD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(FJD|\$|dollars?)/g;
        aRegex1.FKP = /(FKP|FK£|£)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        ...
        aRegex1.GHS = /(GHS|GH₵|GH¢|GH[cC])(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        ...
        aRegex1.GMD = /(GMD|D)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        ...
        aRegex1.GTQ = /(GTQ|Q\.?)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.GTQ = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(GTQ|Q|quetzal(es)?|q)/g;
        aRegex1.GYD = /(GYD|GYD\$|G\$|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.GYD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(GYD|\$|dollars?)/g;
        aRegex1.HKD = /(HKD|HK\$|\$)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.HKD = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(HKD|\$|dollars?)/g;
        aRegex1.HNL = /(HNL|L\.?)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
