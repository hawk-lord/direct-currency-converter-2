const PriceRegexes = (function() {
    const makePriceRegexes = function(aRegex1, aRegex2) {
        ...
        aRegex2.AFN = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(\s؋\s?afs?|افغانۍ|afghanis?|AFN)(?!\w)/g;
        aRegex1.ALL = /(^|\s)(Lekë?|ALL)(\s?(\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?)/g;
        aRegex2.ALL = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(Lekë?|ALL)(?!\w)/g;
        ...
        aRegex2.AWG = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(Afl\.?|\sflorin|AWG)(?!\w)/g;
        ...
        aRegex2.BTN = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(BTN|Ngultrum|དངུལ་ཀྲམ)(?!\w)/g;
        ...
        aRegex2.GHS = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(GHS|cedi)(?!\w)/g;
        ...
        aRegex2.HTG = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(HTG|Gourdes?|gourdes?)(?!\w)/g;
        ...
        aRegex2.MOP = /((\d{1,3}((\,|\.|\s)\d{3})+|(\d+))((\.|\,)\d{1,9})?\s?)(MOP|澳門圓|澳门圆|MOP$|[pP]atacas?)(?!\w)/g;
