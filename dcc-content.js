...
if (!this.DccFunctions) {
    const DccFunctions = (function(){
        ...
        minorUnits.push(new MinorUnit("LAK", 2, []));
        minorUnits.push(new MinorUnit("LBP", 2, []));
        minorUnits.push(new MinorUnit("LKR", 2, []));
        minorUnits.push(new MinorUnit("LRD", 2, []));
        minorUnits.push(new MinorUnit("LSL", 2, []));
        minorUnits.push(new MinorUnit("LYD", 3, []));
        minorUnits.push(new MinorUnit("MAD", 2, []));
        minorUnits.push(new MinorUnit("MDL", 2, []));
        minorUnits.push(new MinorUnit("MGA", 2, []));
        minorUnits.push(new MinorUnit("MKD", 2, []));
        minorUnits.push(new MinorUnit("MMK", 2, []));
        minorUnits.push(new MinorUnit("MNT", 2, []));
        minorUnits.push(new MinorUnit("MOP", 2, []));
        minorUnits.push(new MinorUnit("MRO", 2, []));
        minorUnits.push(new MinorUnit("MUR", 2, []));
        minorUnits.push(new MinorUnit("MVR", 2, []));
        minorUnits.push(new MinorUnit("MWK", 2, []));
        minorUnits.push(new MinorUnit("MXN", 2, []));
        minorUnits.push(new MinorUnit("MXV", 2, []));
        minorUnits.push(new MinorUnit("MYR", 2, []));
        minorUnits.push(new MinorUnit("MZN", 2, []));
        minorUnits.push(new MinorUnit("NAD", 2, []));
        minorUnits.push(new MinorUnit("NGN", 2, []));
        minorUnits.push(new MinorUnit("NIO", 2, []));
        minorUnits.push(new MinorUnit("NOK", 2, ["øre"]));
        minorUnits.push(new MinorUnit("NPR", 2, []));
        minorUnits.push(new MinorUnit("NZD", 2, []));
        minorUnits.push(new MinorUnit("OMR", 3, []));
        minorUnits.push(new MinorUnit("PAB", 2, []));
        minorUnits.push(new MinorUnit("PEN", 2, []));
        minorUnits.push(new MinorUnit("PGK", 2, []));
        minorUnits.push(new MinorUnit("PHP", 2, []));
        minorUnits.push(new MinorUnit("PKR", 2, []));
        minorUnits.push(new MinorUnit("PLN", 2, []));
        minorUnits.push(new MinorUnit("PYG", 0, []));
        minorUnits.push(new MinorUnit("QAR", 2, []));
        minorUnits.push(new MinorUnit("RON", 2, []));
        minorUnits.push(new MinorUnit("RSD", 2, []));
        minorUnits.push(new MinorUnit("RUB", 2, ["kopek", "коп"]));
        minorUnits.push(new MinorUnit("RWF", 0, []));
        minorUnits.push(new MinorUnit("SAR", 2, []));
        minorUnits.push(new MinorUnit("SBD", 2, []));
        minorUnits.push(new MinorUnit("SCR", 2, []));
        minorUnits.push(new MinorUnit("SDG", 2, []));
        minorUnits.push(new MinorUnit("SEK", 2, ["öre"]));
        minorUnits.push(new MinorUnit("SGD", 2, []));
        minorUnits.push(new MinorUnit("SHP", 2, []));
        minorUnits.push(new MinorUnit("SLL", 2, []));
        minorUnits.push(new MinorUnit("SOS", 2, []));
        minorUnits.push(new MinorUnit("SRD", 2, []));
        minorUnits.push(new MinorUnit("SSP", 2, []));
        minorUnits.push(new MinorUnit("STD", 2, []));
        minorUnits.push(new MinorUnit("SVC", 2, []));
        minorUnits.push(new MinorUnit("SYP", 2, []));
        minorUnits.push(new MinorUnit("SZL", 2, []));
        minorUnits.push(new MinorUnit("THB", 2, []));
        minorUnits.push(new MinorUnit("TJS", 2, []));
        minorUnits.push(new MinorUnit("TMT", 2, []));
        minorUnits.push(new MinorUnit("TND", 3, []));
        minorUnits.push(new MinorUnit("TOP", 2, []));
        minorUnits.push(new MinorUnit("TRY", 2, []));
        minorUnits.push(new MinorUnit("TTD", 2, []));
        minorUnits.push(new MinorUnit("TWD", 2, []));
        minorUnits.push(new MinorUnit("TZS", 2, []));
        minorUnits.push(new MinorUnit("UAH", 2, []));
        ...
        minorUnits.push(new MinorUnit("UYU", 2, []));
        minorUnits.push(new MinorUnit("UZS", 2, []));
        minorUnits.push(new MinorUnit("VEF", 2, []));
        minorUnits.push(new MinorUnit("VND", 0, []));
        minorUnits.push(new MinorUnit("VUV", 0, []));
        minorUnits.push(new MinorUnit("WST", 2, []));
        minorUnits.push(new MinorUnit("XAF", 0, []));
        minorUnits.push(new MinorUnit("XAG", 2, []));
        minorUnits.push(new MinorUnit("XAU", 2, []));
        minorUnits.push(new MinorUnit("XBA", 2, []));
        minorUnits.push(new MinorUnit("XBB", 2, []));
        minorUnits.push(new MinorUnit("XBC", 2, []));
        minorUnits.push(new MinorUnit("XBD", 2, []));
        minorUnits.push(new MinorUnit("XCD", 2, []));
        minorUnits.push(new MinorUnit("XDR", 2, []));
        minorUnits.push(new MinorUnit("XOF", 0, []));
        minorUnits.push(new MinorUnit("XPD", 2, []));
        minorUnits.push(new MinorUnit("XPF", 0, []));
        minorUnits.push(new MinorUnit("XPT", 2, []));
        minorUnits.push(new MinorUnit("XSU", 2, []));
        minorUnits.push(new MinorUnit("XTS", 2, []));
        minorUnits.push(new MinorUnit("XUA", 2, []));
        minorUnits.push(new MinorUnit("XXX", 2, []));
        minorUnits.push(new MinorUnit("YER", 2, []));
        minorUnits.push(new MinorUnit("ZAR", 2, []));
        minorUnits.push(new MinorUnit("ZMW", 2, []));
        minorUnits.push(new MinorUnit("ZWL", 2, []));
