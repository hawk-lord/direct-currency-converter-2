...
const PriceRegexes = (function() {
	...
	const makePriceRegexes = function(aRegex1, aRegex2) {
    	...
    	try {
            ...
            aRegex2.DKK = makeRegex2("(DKK|mio\\. kroner|million(er)? kroner|mia\\. kroner|kroner|s?mia\\. kr(ónur)?|milliard(ir)? krónur?|s?mi[oó]\\. kr(ónur)?|millión(ir)? krónur?|mill?jón(ir)? krónur?|krónur?|kr|dkr|:-|,-)");
            ...
            aRegex2.EUR = makeRegex2("(EUR|€|euros?t?a?|евро|evro|euri|eura|ευρώ|evrō|euró|evrur|eiro|eurai|eurų|euras|ewros?|eòrathan|eurá|eúr|evro|evra|evri|evrov)");
