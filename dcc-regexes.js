    ...
    const PriceRegexes = (function() {
        ...
        const makePriceRegexes = function(aRegex1, aRegex2) {
            ...
            try {
                ...
                aRegex2.SEK = makeRegex2("(SEK|öre|(svenska\\s)?kr(onor)?|miljon(er)? kronor|miljard(er)? kr(onor)?|mnkr|mdkr|mkr|s?[kK]r|kSEK|MSEK|GSEK|:-|,-)");
                ...
                aRegex2.USD = makeRegex2("(USD|US\\s?\\$|Us\\s?\\$|\\$|[dD]ollars?|¢|￠|[cC]ents?)");
