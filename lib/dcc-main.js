            ...
            registerToTabsEvents: () => {
                const setTabs = (aTab) => {
                    if (aTab.url === "resource://jid1-ep6btq0bhcevya-at-jetpack/direct-currency-converter/data/index.html") {
                        settingsWorker = aTab.attach({contentScriptFile: [aUrlProvider.getUrl("jquery-2.1.1.min.js"), aUrlProvider.getUrl("jquery-ui-1.10.4.min.js"), aUrlProvider.getUrl("dcc-options.js"), aUrlProvider.getUrl("dcc-firefox-options-adapter.js")]});
