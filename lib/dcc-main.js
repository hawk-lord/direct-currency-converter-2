            ...
            registerToTabsEvents: () => {
                const setTabs = (aTab) => {
                    if (aTab.url === "resource://dcc-at-joint-dot-ax/direct-currency-converter-2/data/settings.html") {
                        settingsWorker = aTab.attach({contentScriptFile: [aUrlProvider.getUrl("common/jquery-2.1.1.min.js"), aUrlProvider.getUrl("common/jquery-ui-1.10.4.min.js"), aUrlProvider.getUrl("common/dcc-settings.js"), aUrlProvider.getUrl("dcc-firefox-settings-adapter.js")]});
