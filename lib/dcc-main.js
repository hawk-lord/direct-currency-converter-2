            ...
            registerToTabsEvents: () => {
                const setTabs = (aTab) => {
                    if (aTab.url === "resource://dcc-at-joint-dot-ax/direct-currency-converter-2/data/settings.html") {
                        settingsWorker = aTab.attach({contentScriptFile: [aUrlProvider.getUrl("common/jquery-2.1.3.min.js"), aUrlProvider.getUrl("common/jquery-ui-1.11.2.min.js"), aUrlProvider.getUrl("common/dcc-settings.js"), aUrlProvider.getUrl("dcc-firefox-settings-adapter.js")]});
                        ...
                        testPageWorker = aTab.attach({contentScriptFile: [aUrlProvider.getUrl("common/dcc-regexes.js"), aUrlProvider.getUrl("common/dcc-content.js"), aUrlProvider.getUrl("dcc-firefox-content-adapter.js")]});
                        const finishedTabProcessingHandler = (aHasConvertedElements) => {
                            try {
