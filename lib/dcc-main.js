                    ...
                    onComplete: (aResponse) => {
                        try {
                            ...
                            if (aResponse.status == "200") {
                                ...
                                console.log("200" + response.country_code);
                            }
                            else {
                                informationHolder.setUserCountry("GB");
                                console.log("!200" + aResponse.status);
                            }
    ...
    const TabsInterface = function(aUrlProvider, anInformationHolder) {
        ...
        return {
            ...
            registerToTabsEvents: () => {
                const setTabs = (aTab) => {
                    if (aTab.url === "resource://dcc-at-joint-dot-ax/direct-currency-converter/data/index.html") {
