...
const FirefoxContentInterface = function(anInformationHolder) {
    ...
    const watchForPages = () => {
        ...
        const setTab = (aTab) => {
            if (aTab.url === "resource://dcc-at-joint-dot-ax/data/settings.html") {
                settingsWorker = aTab.attach({contentScriptFile: ["./common/jquery-2.1.3.min.js", "./common/jquery-ui-1.11.2.min.js", "./common/jquery.ui.touch-punch.js", "./common/dcc-settings.js", "./dcc-firefox-settings-adapter.js"]});
            ...
            else if (aTab.url === "resource://dcc-at-joint-dot-ax/data/common/prices.html") {
