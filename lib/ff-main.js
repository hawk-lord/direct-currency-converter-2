...
const DirectCurrencyConverter = (function() {
    ...
    const ffGeoService = new FirefoxFreegeoipServiceProvider(Request, eventAggregator);
    ...
    const informationHolder = new InformationHolder(defaultExcludedDomains, ffFirefoxStorageServiceProvider, currencyData, currencySymbols, convertFroms, regionFormats, _);
    ...
    const chromeInterface = new SmChromeInterface(_, eventAggregator, informationHolder, button, windowUtils, urlProvider);
    ...
    eventAggregator.subscribe("dccToolsButtonHidden", () => {
        informationHolder.showDccToolsButton = false;
    });
    eventAggregator.subscribe("dccToolsButtonVisible", () => {
        informationHolder.showDccToolsButton = true;
    });
    eventAggregator.subscribe("dccConversionButtonHidden", () => {
        informationHolder.showDccConversionButton = false;
    });
    eventAggregator.subscribe("dccConversionButtonVisible", () => {
        informationHolder.showDccConversionButton = true;
    });
