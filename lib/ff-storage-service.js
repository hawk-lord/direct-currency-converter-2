...
const FirefoxStorageServiceProvider = function(aRequired) {
    ...
    return {
        ...
        get convertToCurrency () {
            // apparently this is called at installation before storage.dccPrefs.convertToCurrency is set
            // ReferenceError: reference to undefined property storage.dccPrefs.convertToCurrency
