...
const InformationHolder = function(aUrlProvider, aStorageService) {
    ...
    return {
        ...
        convertToCurrency: convertToCurrency.convertToCurrency,
        convertToCountry: convertToCountry.convertToCountry,
        getCurrencySymbols: getCurrencySymbols,
        customSymbols: customSymbols.customSymbols,
        decimalSep: decimalSep.decimalSep,
        enableOnStart: enableOnStart.enableOnStart,
        excludedDomains: excludedDomains.excludedDomains,
        enabledCurrencies: enabledCurrencies.enabledCurrencies,
        quoteAdjustmentPercent: quoteAdjustmentPercent.quoteAdjustmentPercent,
        roundPrices: roundPrices.roundPrices,
        separatePrice: separatePrice.separatePrice,
        showOriginalPrices: showOriginalPrices.showOriginalPrices,
        unitAfter: unitAfter.unitAfter,
        tempConvertUnits: tempConvertUnits.tempConvertUnits,
        thousandSep: thousandSep.thousandSep,
        conversionEnabled: conversionEnabled.conversionEnabled,
