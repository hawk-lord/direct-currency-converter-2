 ...
 * @constructor
 */
const InformationHolder = function(aStorageService) {
    "use strict";
    ...
    var _thousandSep = " ";
    var _conversionEnabled = aStorageService.enableOnStart;
    ...
    const makeQuoteString = (aConvertFromCurrency) => {
        ...
        if (aConvertFromCurrency != aStorageService.convertToCountry) {
            const quoteString = "1 " + aConvertFromCurrency + " = " + conversionQuote.replace(".", aStorageService.decimalSep) + " " + aStorageService.convertToCountry;
    ...
    return {
        get convertToCountry () {
            console.log("aStorageService.convertToCountry " + aStorageService.convertToCountry);
        ...
        get excludedDomains () {
            console.log("aStorageService.excludedDomains " + aStorageService.excludedDomains);
